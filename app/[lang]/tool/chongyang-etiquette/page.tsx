          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6">
              ...
              <div className="bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-sm">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  ...
                  <li>
                    • Avoid arguing or disagreeing loudly in their presence
                  </li>
                  <li>
            ...
            <div className="mt-8 bg-gradient-to-r from-orange-100/80 to-amber-100/80 dark:from-orange-900/30 dark:to-amber-900/20 rounded-2xl p-6 text-center">
              ...
              <p className="text-muted-foreground">
                Chongyang Festival reminds us to cherish our elders while we
                can. The Chinese character &quot;yang&quot; (阳) represents yang
                energy and vitality - spending time with elders brings blessings
                and good fortune.
              </p>
            </div>
          </div>
